...
function mengelompokkanAngka(arr) {
  ...
  let arr1 = []; //array yang menampung bilangan genap
  let arr2 = []; //array yang menampung bilangan ganjil
  let arr3 = []; //array yang menampung kelipatan 3

  for (let i = 0; i < arr.length; i++) {
    if (arr[i] % 3 === 0) {
      //mencari bilangan kelipatan 3
      arr3.push(arr[i]);
    } else if (arr[i] % 2 !== 0) {
