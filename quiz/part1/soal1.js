...
function dataHandling(output) {
    for( let i = 0; i < output.length; i++) {
        console.log('Nomor ID :', output[i][0])
        console.log('Nama Lengkap :', output[i][1])
        console.log('TTL :', output[i][2], output[i][3])
        console.log('Hobi :', output[i][4])
        console.log()
    }
};
dataHandling(input)
