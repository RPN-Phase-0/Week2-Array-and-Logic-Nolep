...
for (dataHandling of input) {
  console.log(`Nomor ID: ${dataHandling[0]}`);
  console.log(`Nama Lengkap: ${dataHandling[1]}`);
  console.log(`TTL: ${dataHandling[2]} ${dataHandling[3]}`);  
  console.log(`Hobi: ${dataHandling[4]}`);
  console.log();
}
// /*
