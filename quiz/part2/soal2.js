...
Contoh, jika angka adalah 27, maka function akan me-return nilai 33 karena angka
33 adalah angka palindrom. Jika angka dari awal sudah merupakan palindrome,
...
function angkaPalindrome(num) {
    ...
    while (true) {
        ...
        let reversed = strNum.split('').reverse().join(''); // Balik angka

        if (strNum === reversed) {
            return num; // Jika angka palindrome, return angka tersebut
        }

        num++; // Jika bukan palindrome, lanjut ke angka berikutnya
    }
}
