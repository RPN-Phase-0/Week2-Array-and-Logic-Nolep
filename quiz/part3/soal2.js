...
function perkalianUnik(arr) {
    let totalKali = arr.reduce((acc, num) => acc * num, 1);//mengalikan semua angka dalam arrya
    return arr.map(num =>totalKali / num);//membuaat array baru menggunakan hasil pembagian
  }
